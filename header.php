...
<html xmlns="http://www.w3.org/1999/xhtml" <?php language_attributes(); ?>>
    ...
    <div id="top">
    	<ul id="top-links">
        	<li id="drupal-wordpress">Drupal & Wordpress</li>
            <li id="interaction-design">Interaction Design</li>
            <li id="usability-testing">Usability testing</li>
        </ul>
        <div id="my-header" onclick="window.location='http://danpolant.com'" style="cursor:pointer;">
